...
public class YAMLReadConstraintsTest extends ModuleTestBase
{
    ...
    private final YAMLMapper NAME_LIMIT_MAPPER = new YAMLMapper(
            YAMLFactory.builder()
    ...
    private final YAMLMapper STRING_LIMIT_MAPPER = new YAMLMapper(
            YAMLFactory.builder()
                .streamReadConstraints(StreamReadConstraints.builder()
    ...
    public void testNameTooLong() throws Exception
    {
        ...
        final String doc = longName + ": value\n";

        try {
            NAME_LIMIT_MAPPER.readTree(doc);
    ...
    public void testStringValueTooLong() throws Exception
    {
        ...
        final String doc = "key: " + longValue + "\n";

        try {
            STRING_LIMIT_MAPPER.readTree(doc);
            fail("expected StreamConstraintsException");
        } catch (StreamConstraintsException e) {
