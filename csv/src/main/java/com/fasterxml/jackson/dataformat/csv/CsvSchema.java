 ...
 * </ul>
 */
public class CsvSchema implements FormatSchema, Iterable<CsvSchema.Column>, java.io.Serializable // since 2.5
{
    ...
    public static class Builder {
        ...
        protected String _pathSeparator = DEFAULT_PATH_SEPARATOR;
         ...
         */
        public Builder addColumn(String name, String pathSeparator) {
            int index = _columns.size();
            return addColumn(new Column(index, name, pathSeparator));
        }
        ...
        public Builder addColumn(String name) {
            int index = _columns.size();
            return addColumn(new Column(index, name, _pathSeparator));
        }
         ...
         * accidentally add duplicates.
         */
        public Builder addColumn(String name, ColumnType type, String _pathSeparator) {
            int index = _columns.size();
            return addColumn(new Column(index, name, type, "", _pathSeparator));
        }
     ...
     */
    @Deprecated // in 2.7; remove from 2.8
    public CsvSchema(Column[] columns, int features, char columnSeparator, int quoteChar, int escapeChar, char[] lineSeparator, int arrayElementSeparator,
                     char[] nullValue) {
        this(columns, features, columnSeparator, quoteChar, escapeChar, lineSeparator,
             arrayElementSeparator == -1 ? "" : Character.toString((char) arrayElementSeparator), nullValue, DEFAULT_ANY_PROPERTY_NAME);
    }

    /**
     * @since 2.7
     */
    public CsvSchema(Column[] columns, int features, char columnSeparator, int quoteChar, int escapeChar, char[] lineSeparator, String arrayElementSeparator,
     ...
     */
    protected CsvSchema(Column[] columns, int features, char columnSeparator, int quoteChar, int escapeChar, char[] lineSeparator, String arrayElementSeparator,
                        char[] nullValue, Map<String, Column> columnsByName, String anyPropertyName) {
        _columns = columns;
        _features = features;
        _columnSeparator = columnSeparator;
        _quoteChar = quoteChar;
